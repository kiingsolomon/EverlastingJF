                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: Text(
                                'Everlasting Joy is a nonprofit organization. We’ve helped over 5,000 people learn valuable skills, feed the needy, provided financial support to those in need and improve their ability to live fulfilling lives.',
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: Text(
                                'We rise by helping people in need around the globe. We can join hands to bring hope and possiblities to needy in various communities. Join us put smile in the faces of people today.',
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ).animateOnPageLoad(
